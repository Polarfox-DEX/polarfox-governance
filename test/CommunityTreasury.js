...
//         it('PFX', async function () {
//             expect(await this.community.pfx()).to.equal(this.pfx.address);
//         });
...
//             expect(await this.pfx.balanceOf(this.community.address)).to.equal(transferAmount);
//             expect(await this.pfx.balanceOf(this.addr2.address)).to.equal(0);

//             await this.community.transfer(this.addr2.address, transferAmount);
//             expect(await this.pfx.balanceOf(this.addr2.address)).to.equal(transferAmount);
//         });
...
//             const transferAmount = oneToken.mul(100);
//             expect(await this.pfx.balanceOf(this.community.address)).to.equal(0);

//             await expect(this.community.transfer(this.addr2.address, transferAmount)).to.be.revertedWith(
//                 'Pfx::_transferTokens: transfer amount exceeds balance'
//             );
//         });
//     });

...
describe('StakingRewards', function () {
    before(async function () {
        ...
        this.LpToken = await ethers.getContractFactory("Pfx");
    ...
    beforeEach(async function () {
        ...
        this.stakingRewards = await this.StakingRewards.deploy(this.pfx.address, this.lpToken.address);
    ...
    describe("startVesting", function () {
        it('Start vesting successfully', async function () {
            ...
            await this.pfx.transfer(this.stakingRewards.address, vestAmount);
            ...
            expect(await this.pfx.balanceOf(this.addr2.address)).to.equal(actualAmount);
        ...
        it('Two stakers, same time', async function () {
            ...
            expect(await this.pfx.balanceOf(this.addr2.address)).to.equal(actualAmount);
            expect(await this.pfx.balanceOf(this.addr3.address)).to.equal(actualAmount);
        ...
        it('Two stakers, different times', async function () {
            ...
            await this.stake2.getReward();
            await this.stake3.getReward();
            expect(await this.pfx.balanceOf(this.addr2.address)).to.equal(largerAmount);
            expect(await this.pfx.balanceOf(this.addr3.address)).to.equal(smallerAmount);
        });
        ...
        it('Early withdraw, the whole second period', async function () {
            ...
            expect(await this.pfx.balanceOf(this.addr2.address)).to.equal(smallerAmount);

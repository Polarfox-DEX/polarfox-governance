...
contract GovernorAlpha {
    ...
    constructor(address timelock_, address pfx_) public {
    ...
    function propose(
        ...
        require(
            pfx.getPriorVotes(msg.sender, sub256(block.number, 1)) >= proposalThreshold(),
        ...
        uint256 endTime = add256(block.timestamp, add256(votingPeriod(), votingDelay()));
    ...
    function cancel(uint256 proposalId) public {
        ...
        Proposal storage proposal = proposals[proposalId];
        require(
            pfx.getPriorVotes(proposal.proposer, sub256(block.number, 1)) < proposalThreshold(),
